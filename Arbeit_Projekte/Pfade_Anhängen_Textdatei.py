...
def main():
        ...
        for datei in dateien:
            ...
            try:
                ...
                if alter_projektname in inhalt:
                    ...
                    dateipfad_Endung = dateipfad[index + 5:]
                    passende_dateien.append(dateipfad_Endung)
    ...
    if passende_dateien:
        ...
        with open(os.path.join(projektpfad, "Gefundene_Pfade.txt"), "a") as textdatei:
            for dateipfad in passende_dateien:
                textdatei.write(dateipfad + "\n")
    else:
